...
export const MarginAccordion = withTranslation()(({ t, props, setProp, styleProp = "parentStyle" }) => {
  return (
    <CustomAccordion
      title={t("margin")}
      preview={
...
export const BorderAccordion = withTranslation()(({ t, props, setProp, styleProp = "style" }) => {
  var borderString =
...
export const ActionAccordion = withTranslation()(({ t, props, setProp }) => {
  return (
    <CustomAccordion
      title={t("action")}
      preview={
...
export const BackgroundAccordion = withTranslation()(({ t, props, setProp, isSelfBg, defaultImage }) => {
...
export const AlignmentAccordion = withTranslation(({ t, props, setProp }) => {
  return (
    <CustomAccordion
      title={t("alignment")}
      preview={
...
export const ColorAccordion = withTranslation()(({ t, props, setProp, types }) => {
  return (
    <CustomAccordion
      title={t("colors")}
      preview={
